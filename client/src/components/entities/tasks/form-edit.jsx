        ...
        <Card className="border-none bg-none h-full flex flex-col">
          ...
          <CardContent className="py-0 mb-0 grow">
            <div className="flex flex-wrap flex-col gap-3 py-6">
              ...
              {/* Related To */}
<div className="flex items-center gap-1">
  <span className="text-s font-medium text-zinc-500 w-28">Related To</span>
  <FormField
    control={form.control}
    name="relatedTo"
    render={({ field }) => (
      <FormItem>
        <FormControl>
          ...
          >
            ...
            <option value="">Select</option>
<option value="Tech Innovators Pvt. Ltd.">Tech Innovators Pvt. Ltd.</option>
<option value="Global Digitals">Global Digitals</option>
<option value="Smart Builders">Smart Builders</option>
<option value="Future Computers">Future Computers</option>
<option value="HealthLine Pvt. Ltd.">HealthLine Pvt. Ltd.</option>
<option value="Edu Smart Solutions">Edu Smart Solutions</option>
<option value="Alpha Business Solutions">Alpha Business Solutions</option>
<option value="Velocity Core">Velocity Core</option>
          </select>
        </FormControl>
        <FormMessage />
      </FormItem>
